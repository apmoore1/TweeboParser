...
## NEWS
```
June 3, 2018 -- Added a Python API
...
tests ---- The scripts that are used to Test both the original TweeboParser is working the same compared to new changes and the Python tests to ensure the Python API is working as expected.
tweebo ---- The Python API directory. [tweebo/tweebo.py](./tweebo/tweebo.py) contains the API to the TweeboParser.
```
